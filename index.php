...
<link rel="stylesheet" href="http://localhost/myservice/css/index.css"/>
...
<script type="text/javascript" src="http://localhost/myservice/js/index.js"></script>
<script type="text/javascript" src="http://localhost/myservice/js/valueCheck.js"></script>
</head>
<body>
    ...
    <div id="container">
        ...
        <section id="signup">
            <div id="signupCenter">
                ...
                <form id="signUpForm" method="post" action="http://localhost/myservice/database/myMember.php">
                    <div class="row">
                        <div class="inputBox">
                	...
                	<?php
                         //현재 연도를 구함
                         $nowYear = date('Y',time());
                         //현재 연도부터 1950년도까지 내림차순으로 option 태그 생성
                         for($i = $nowYear; $i >= 1950; $i--){?>
