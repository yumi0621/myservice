$(document).ready(function(){
                ...
                success: function (data){
                    ...
                    if(data.result == true){
                        ...
                        for(var contents in content){
                            ...
                            //공감한 게시물에는 '취소,', 공감하지 않은 것은 '하기' 문구를 selectLike 변수에 대입
                            ...
                            inputHtml += "<div class='contentsID'>콘텐츠 번호 : " + content[contents] ['contentsID'] + "</div>";
                            inputHtml += "</div>";
                            ...
                            for(var comment in comments){
                                ...
                                inputHtml += "<p class='commentRegTime'>" + regTime + "</p>"; inputHtml += "<p class='commentPoster'>" + comments[comment]['userName']
    ...
    $(document).on('click', '.regCommentBtn', function(){
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                //여기에서 등록한 댓글을 화면에 표시하는 기능 구현해야 함
                if(data.result == true){
                    //등록시간 만들기
    ...
    $(document).on('click', '.likeBtn', function(){
        ...
        //likesController에 mode명 reflection과 공감할 콘텐츠 번호 전송
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.result == true){
                    ...
                    //게시물에 공감취소 했을 때 버튼 내용 변경 및 배경색 변경
                    else{
                        //공감 수 영역 배경색 흰색으로 변경
